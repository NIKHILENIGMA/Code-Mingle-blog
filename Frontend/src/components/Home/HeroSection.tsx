  ...
  return (
    <section className="relative z-10 flex items-center justify-center h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-start w-full h-full pt-32 space-y-2">
        <span className="px-4 py-1 text-sm text-center rounded-full text-white/80 bg-gradient-to-r from-primary to-primary/40">
          Easy to use, powerful, and flexible platform for your needs.
        </span>
        <h1 className="mb-4 text-4xl font-bold tracking-tight text-center text-secondary-foreground sm:text-5xl md:text-6xl">
          Unleash Your Words:
        </h1>
        <h1 className="mb-4 text-4xl font-bold tracking-tight text-center text-secondary-foreground sm:text-5xl md:text-6xl">
