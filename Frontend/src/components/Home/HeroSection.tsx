...
const HeroSection: FC = () => {
  return (
    <section className="relative z-10 flex items-center justify-center h-screen overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-full h-20 bg-linear-to-t from-background to-transparent "></div>

      <div className="relative z-20 flex flex-col items-center justify-start w-full h-full pt-32 space-y-2">
        <span className="hidden px-4 py-1 text-sm text-center rounded-full md:block text-white/80 bg-linear-to-r from-primary to-primary/40">
