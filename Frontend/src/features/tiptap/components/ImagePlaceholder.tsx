...
const ImagePlaceholder: FC<ReactNodeViewProps> = ({
  selected,
  deleteNode,
  extension,
  editor,
        ...
        >
          <Tabs defaultValue="upload" className="w-full">
            <TabsList className="w-full space-x-3 bg-transparent">
              <TabsTrigger value="upload" className="p-2">
                Image Upload
              </TabsTrigger>
              <TabsTrigger value="url" className="p-2">
                Embedded URL
              </TabsTrigger>
            </TabsList>
            ...
            >
              ...
              <Button type="button" className="w-full" onClick={handleEmbed}>
                Embed
              </Button>
            </TabsContent>
          </Tabs>
